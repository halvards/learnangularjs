...
var httpInterceptorsModule = angular.module('httpInterceptors', ['ng']);

httpInterceptorsModule.factory('logResponseInterceptor', function ($log) {
...
httpInterceptorsModule.factory('detectErrorInterceptor', function ($q, $log, $location) {
  return function (promise) {
    return promise.then(
      function success(response) {
        return response;
